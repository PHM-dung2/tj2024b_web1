...
const func7 = ( ) => {
	...
	fetch( `/tj2024b_web1/day02/example2?name=${ name }&age=${ age }` , { method : 'POST' })
} // f end

const func8 = ( ) => {
	let name = '서장훈';	let age = 40;
	fetch( `/tj2024b_web1/day02/example2?name=${ name }&age=${ age }` , { method : 'PUT' })
} //f end

const func9 = ( ) => {
	let name = '김희철';	let age = 50;
	fetch( `/tj2024b_web1/day02/example2?name=${ name }&age=${ age }` , { method : 'DELETE' })
} //f end
...
const func10 = ( ) => {
	...
	const option = {
		...
		body : JSON.stringify( object ) // HTTP통신은 문자열 자로면 전송이 가능하다.
	} // o end
