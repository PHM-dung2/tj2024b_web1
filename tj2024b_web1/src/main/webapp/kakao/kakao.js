...
/*
	// (1) HTML의 div를 가져오기
	// getElementById('map') => querySelector('#map")으로 바꿔도 동작함
var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { // (2) 처음에 지도가 여렸을 때 중심 좌표롸 확대레벨 설정
        center: new kakao.maps.LatLng(37.4910841087311 , 126.72057774665798), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨 , 0(최대확대) ~ 14(최대축소)
    };
...
var map = new kakao.maps.Map(mapContainer, mapOption); // 지도를 생성합니다
	...
	// (4) 표기할 준비
	// 마커를 표시할 위치와 title 객체 배열입니다 , 활용 : fetch 이용하여 마커에 표시할 
var positions = [
    {
        title: '카카오', 
...
// + jQuery(JS라이브러리) 함수 +&libraries=clusterer
