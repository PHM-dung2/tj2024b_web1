...
//	ArrayList< HashMap< dto > > list = new ArrayList<>();
...
//		(1) HTTP 요청된 BODY 자료들을 HashMap타입으로 변환하기
...
//		(5) 출력할 내용물 , list 타입을 (JSON형식)문자열 타입으로 변환
...
//	2. 파일 내용 가져오기
	@Override // http://192.168.40.45:8080/tj2024b_web1/day09/example3
